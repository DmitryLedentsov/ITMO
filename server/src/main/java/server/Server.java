...
import common.connection.request.AuthMsg;
import common.connection.request.RequestVisitor;
import common.data.*;
...
public class Server extends Thread implements SenderReceiver {
    ...
    private RequestVisitor requestVisitor;
    ...
    private void init(int p, String path) throws ConnectionException {
        ...
        requestVisitor = new RequestVisitor() {
            @Override
            ...
            @Override
            public void visit(common.connection.request.CommandMsg msg) {
            ...
            try {
                try {
                    ...
                    if (commandMsg.getWorker() != null) {
                        commandMsg.getWorker().setCreationDate(new Date());
                    }
